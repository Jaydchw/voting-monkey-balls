...
export function ShuffleMonkey({
  ...
  return (
    <div className="relative h-24 sm:h-28 mb-3 -mt-3 sm:-mt-4">
      <Image
        src={monkeyImageSrc}
        alt="Monkey"
        width={136}
        height={136}
        className="absolute left-1/2 -top-3 sm:-top-4 -translate-x-1/2 w-24 h-24 sm:w-28 sm:h-28 object-contain"
      />
